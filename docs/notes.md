...
<!-- TODO, seperate the publishOrder, w/ "byProductId, externalImage, existingSKU"? -->
...
| 1 | **standard** | standard | | 2 | **express** | priority | | 3 | **printify_express | express | | 4 |**economy\*\* | economy |
...
#### `printify.uploads.archiveImage(imageId)`
