...
Steps to configure/update the `npm publish` [workflow](https://github.com/spencerlepine/spencerlepine-sdk-js/blob/main/.github/workflows/npm-publish.yml) for automated
`npm publish`.
...
Creating a release and triggering the `npm publish` [workflow](https://github.com/spencerlepine/spencerlepine-sdk-js/blob/main/.github/workflows/npm-publish.yml).
...
1. Create a GitHub release: <https://docs.github.com/en/repositories/releasing-projects-on-github/managing-releases-in-a-repository>
   ...
   - Head to <https://github.com/spencerlepine/spencerlepine-sdk-js/releases>
   - Draft new release
...
2. Workflow is triggered on release (or you can trigger with manual `workflow_dispatch`):
   ...
   - Head to <https://github.com/spencerlepine/spencerlepine-sdk-js/actions>
